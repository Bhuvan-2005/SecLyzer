...
# Configuration
RUST_EXTRACTORS_DIR = Path(__file__).parent.parent.parent / "test_environment" / "extractors_rs" / "target" / "release"
...
class TestRustBinaries:
    ...
    def test_keystroke_extractor_binary_exists(self):
        ...
        assert KEYSTROKE_BINARY.exists(), f"keystroke_extractor not found at {KEYSTROKE_BINARY}"
        assert os.access(KEYSTROKE_BINARY, os.X_OK), f"keystroke_extractor is not executable"
    ...
    def test_app_tracker_binary_exists(self):
        ...
        assert APP_TRACKER_BINARY.exists(), f"app_tracker not found at {APP_TRACKER_BINARY}"
...
class TestRustExtractorStartup:
    ...
    def test_keystroke_extractor_startup(self, redis_client):
        ...
        try:
            ...
            # Send a test event
            redis_client.publish("seclyzer:events", json.dumps({
                "type": "keystroke",
...
class TestRustExtractorPerformance:
    ...
    def test_keystroke_extractor_startup_time(self):
        ...
        try:
            ...
            assert startup_time < 2.0, f"keystroke_extractor took {startup_time}s to start"
...
class TestRustExtractorIntegration:
    ...
    def test_all_extractors_run_simultaneously(self, redis_client):
        ...
        try:
            ...
            for i, process in enumerate(processes):
                assert process.poll() is None, f"Extractor {i} crashed during integration test"
...
class TestRustExtractorResilience:
    ...
    def test_keystroke_extractor_handles_missing_fields(self, redis_client):
        ...
        try:
            ...
            # Should still be running
            assert process.poll() is None, "keystroke_extractor crashed on missing fields"
    ...
    def test_keystroke_extractor_handles_wrong_event_type(self, redis_client):
        ...
        try:
            ...
            # Should still be running
            assert process.poll() is None, "keystroke_extractor crashed on wrong event type"
